  ...
  <aside class="left-sidebar" style="background: linear-gradient(to bottom, #102742 0%, #0f67cf 100%);">
    <div style="padding-top: 1rem;">
      <div class="brand-logo d-flex align-items-center justify-content-between">
        <a href="dashboard.php" class="text-nowrap logo-img poppins-semibold">
          <img style="margin-left: 0rem; height: 4rem;" src="../src/image/Cuplikan_layar_2024-10-18_142420-removebg-preview 1.png" alt="" />
        </a>
      ...
      <nav class="sidebar-nav scroll-sidebar" data-simplebar="" >
        ...
        <p style="color: white; margin-left: 2.8rem; line-height: 1px; font-size: 0.8rem">Casting Plant Karawang</p>
      </nav>
    </div>
  </aside>
</div>
